                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('perfil.update') }}">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono', $usuario->telefono) }}" autocomplete="telefono">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6">
                                <textarea id="direccion" class="form-control @error('direccion') is-invalid @enderror" name="direccion" autocomplete="direccion">{{ old('direccion', $usuario->direccion) }}</textarea>
